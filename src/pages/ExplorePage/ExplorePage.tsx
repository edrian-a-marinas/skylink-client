...
const DESTINATIONS: Destination[] = [
  { id: "1", name: "Cebu",             location: "Philippines", duration: "1h 20m", price: "From ₱1,890",  bgClass: "bg-primary-60" },
  { id: "2", name: "Puerto Princesa",  location: "Philippines", duration: "1h 20m", price: "From ₱2,499",  bgClass: "bg-success-70" },
  { id: "3", name: "Kalibo (Boracay)", location: "Philippines", duration: "1h 10m", price: "From ₱1,650",  bgClass: "bg-info-50"    },
  { id: "4", name: "Davao",            location: "Philippines", duration: "1h 45m", price: "From ₱1,750",  bgClass: "bg-primary-80" },
  { id: "5", name: "Singapore",        location: "Singapore",   duration: "4h 00m", price: "From ₱7,500",  bgClass: "bg-primary-70" },
  { id: "6", name: "Tokyo",            location: "Japan",       duration: "4h 15m", price: "From ₱18,500", bgClass: "bg-secondary-60" },
  { id: "7", name: "Hong Kong",        location: "Hong Kong",   duration: "2h 30m", price: "From ₱11,200", bgClass: "bg-secondary-70" },
  { id: "8", name: "Bali",             location: "Indonesia",   duration: "3h 10m", price: "From ₱6,200",  bgClass: "bg-success-60" },
];
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-3 left-3">
        ...
        <p className={`${typography.label.sm.semiBold} text-white/90 mt-1`}>{dest.price}</p>
      </div>
    </button>
  );
}
  ...
  return (
    ...
    >
      <div className="relative h-[130px] bg-tertiary-20">
        {deal.image && <img src={deal.image} alt={deal.title} className="absolute inset-0 w-full h-full object-cover" />}
        <span className={`absolute top-2 left-2 bg-danger-60 text-white ${typography.label.xs.bold} px-2 py-0.5 rounded-full`}>
          {deal.discount}
        </span>
        <span className={`absolute top-2 right-2 ${deal.badgeClass} text-white ${typography.label.xs.semiBold} px-2 py-0.5 rounded-full`}>
          {deal.badge}
        </span>
      </div>
      <div className="p-4">
      ...
      <div className="max-w-[1131px] mx-auto px-6 py-10 flex flex-col gap-12">
        ...
        <section>
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className={`${typography.heading.h3.bold} ${colors.text.primary}`}>Popular Destinations</h2>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              ...
              <h2 className={`${typography.heading.h3.bold} ${colors.text.primary}`}>Best Deals</h2>
            </div>
            <button
              type="button"
              className={`${typography.label.sm.semiBold} ${colors.text.link} flex items-center gap-1`}
            >
              See all <HiChevronRight size={16} strokeWidth={1} className={`shrink-0 text-primary-60`} />
            </button>
          </div>
